from app.services import authService, dealService, missionService, phoneService, userService, pointService
...
pointServiceServicer = pointService.PointServiceServicer
